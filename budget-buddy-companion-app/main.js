...
//skinslet graySkin = new Skin({ fill : "#C4C4C4" });let budgetbuddySkin = new Skin({ fill : "white" });let shoppingbuttonSkin = new Skin({ fill : "#1276DD" });let startshoppingbuttonSkin = new Skin({ fill : "#1276DD" });let shoppingbarSkin = new Skin({ fill : "#4F4F4F" });
let bluskin = new Skin({ fill : "#5DA7F3" });let shoppinglistSkin = new Skin({ fill : "#5DA7F3" });let shoppingcartSkin = new Skin({ fill : "white" });let greenbudgetSkin = new Skin({ fill: "#5AF852" });let redbudgetSkin = new Skin({ fill: "#FF5458" });let yellowbudgetSkin = new Skin({ fill: "#FFBC54" });let checkoutSkin = new Skin({ fill : "#1276DD" });
// Budget color indicators
let greenSkin = new Skin ({fill: '#5AF852'});
let redSkin = new Skin ({fill: '#FF5458'});
let yellowSkin = new Skin ({fill: "#FFBC54"});
let orangeSkin = new Skin ({fill: "#FFBC54"});let textStyle = new Style({ font: "bold 20px", color: "black" });let whiteTextStyle = new Style({ font: "bold 20px", color: "white" });let whiteTextStyleBig = new Style({ font: "bold 30px", color: "white" });let grayTextStyle = new Style({ font: "bold 20px", color: "gray" });let bigStyle = new Style({ font: "bold 48px", color: "black" });
